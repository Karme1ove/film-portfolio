        ...
        <main className="min-h-screen w-full bg-[#050505] text-[#dcdcdc] relative selection:bg-red-900/30 pb-20 lg:pb-0">
            ...
            <div className="relative flex flex-col items-center justify-start px-4 py-12 md:p-12 min-h-screen lg:mx-[80px]">
                ...
                <div className="max-w-5xl w-full z-10 lg:mt-12 flex flex-col items-center">
                    {/* TYTUŁ */}
                    <h1 className="font-serif italic text-4xl md:text-8xl mb-8 md:mb-16 text-center mix-blend-exclusion opacity-90 leading-tight">
                        Obciążeni<br/>Złem
                    </h1>

                    {/* PLAYER */}
                    <div className="w-full mb-8">
                        <StalkerPlayer src="https://braslawskifilmy.blob.core.windows.net/video/obciazeni.mp4" />
                    </div>
                    ...
                    <section className="w-full mt-12 md:mt-20 border-t border-white/10 pt-12 md:pt-16 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 text-left">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="font-serif text-lg md:text-xl text-zinc-400 leading-relaxed italic opacity-90 text-justify md:text-left">
                                „Radziecki naukowiec, Sergiej Manochin, zawiera pakt z Demiurgiem – istotą pragnącą uwolnić ludzkość od zła. W zamian za udowodnienie swojej teorii cmentarzy gwiezdnych, Manochin zostaje jego sekretarzem, oceniając szalonych kandydatów z planami na zbawienie świata.”
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col justify-center md:border-l border-white/5 md:pl-12 pt-8 md:pt-0 border-t md:border-t-0 border-white/5">
                            <dl className="grid grid-cols-[100px_1fr] gap-y-6 font-mono text-xs">
                                ...
                                <dt className="text-zinc-600 uppercase tracking-widest mt-4">Reżyseria</dt>
                                <dd className="text-zinc-200 uppercase mt-4">Sergiusz Brasławski</dd>
                                ...
                                <dd className="text-zinc-200 uppercase">David Latuszek</dd>

                                <dt className="text-zinc-600 uppercase tracking-widest">Producent</dt>
                                <dd className="text-zinc-200 uppercase">Mateusz Kupś</dd>
                                ...
                                <dd className="text-zinc-200 uppercase leading-relaxed text-zinc-400">
                                    Michał Przybyszewski, Arkadiusz Buszko, Mateusz Ciurkot, Henryk Gęsikowski, Zofia Wardacka, Kacper Stencel
                                </dd>
                            </dl>
                        </div>
                    </section>
